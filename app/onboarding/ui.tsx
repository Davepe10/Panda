...
export default function Onboarding() {
  ...
  if (createdCode) return <main className="auth"><div className="eyebrow">Espacio creado</div><h2>Invita a la otra persona 🤍</h2><p className="muted">Comparte este código únicamente con la persona que quieres vincular.</p><div className="inviteCode">{createdCode}</div><button className="btn" onClick={()=>{router.replace('/app');router.refresh()}}>Entrar a Pandalandia</button></main>
